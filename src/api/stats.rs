...
#[get("/vn/std")]
async fn get_vn_std(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_vn_std(q.into_inner())?))
}
#[get("/vn/taiko")]
async fn get_vn_taiko(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_vn_taiko(q.into_inner())?))
}
#[get("/vn/catch")]
async fn get_vn_catch(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_vn_catch(q.into_inner())?))
}
#[get("/vn/mania")]
async fn get_vn_mania(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_vn_mania(q.into_inner())?))
}

#[get("/rx/std")]
async fn get_rx_std(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_rx_std(q.into_inner())?))
}
#[get("/rx/taiko")]
async fn get_rx_taiko(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_rx_taiko(q.into_inner())?))
}
#[get("/rx/catch")]
async fn get_rx_catch(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
  Ok(HttpResponse::Ok().json(Stats::get_rx_catch(q.into_inner())?))
}

#[get("/ap/std")]
async fn get_ap_std(q: Query<QueryFormat>) -> Result<HttpResponse, SeverError> {
